defmodule PropSchema.Generator do
  ...
  @spec generate_valid_prop_test(atom(), props(), atom()) :: Macro.t()
  ...
  @spec generate_valid_prop_test(atom(), prop(), props(), atom()) :: Macro.t()
  ...
  @spec generate_invalid_prop_test(atom(), prop(), props(), atom()) :: Macro.t()
...
#    ExpressionModifier.inject_argmument(ast, nil)
  end
